...
SECRET_KEY = 'vfagrl#n+=0amy22j)buv0wbh!9240^=_e8c_y(=50-&tmg#-j'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'the_wall_db', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
